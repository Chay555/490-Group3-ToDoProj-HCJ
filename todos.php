...
<html lang="en">
  ...
  <header class="py-3 mb-4 border-bottom">
    ...
    <form name="form" id="form" method="post" action="database.php">
            ...
            <!--task-->
            <input type="text" name="name" id="task" size="40" placeholder="Add a task">
            <input type="text" name="description" id="description" size="60" placeholder="Description">
            <label for="date"><strong>DueDate: </strong></label>
